...
#if defined (CONFIG_TOUCHSCREEN_GT9157)

static int gt9157_init_platform_hw(void)
{
	int rc = 0;
...
struct goodix_platform_data goodix_info = {
	.init_platform_hw = gt9157_init_platform_hw,
};
#endif
...
#endif
//#define CYTTSP4_I2C_RST_GPIO RK30_PIN2_PB7
#define CYTTSP4_I2C_RST_GPIO RK30_PIN2_PB7
...
#if defined (CONFIG_TOUCHSCREEN_CATA_MSG2238) && defined(CONFIG_MACH_RK3026_T63)
		{
			.type = "msg2xxx",
			.addr = 0x26,
		},
...
static struct cpufreq_frequency_table dvfs_arm_table[] = {
	...
	{.frequency = 816 * 1000,		.index = 1300 * 1000},
...
static struct cpufreq_frequency_table dvfs_ddr_table[] = {
	...
	{.frequency = 400 * 1000 + DDR_FREQ_NORMAL, 	.index = 1300 * 1000},
	{.frequency = CPUFREQ_TABLE_END},
};

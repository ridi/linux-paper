...
int boot_ani_init();
int boot_ani_next_frame(struct ebc_panel *panel_info,struct ebc_buf_s *dest_buf);
int boot_ani_get_low_power_frame(struct ebc_panel *panel_info,struct ebc_buf_s *dest_buf);

...
#include "MSG2238_XY_6236_V1.06_xxxx.h"
#include "MSG2238_XY_6236_V1.06_yyyy.h"
...
void _DrvFwCtrlMsg22xxCheckFirmwareUpdateBySwId(void)
{
    ...
    if (nCrcMainA == nCrcMainB && nCrcInfoA == nCrcInfoB) // Case 1. Main Block:OK, Info Block:OK
    {
        ...
        {
			printk(KERN_ERR "[slr] use msg2xxx_xxxx_update_bin\n");        
        ...
        {
 			printk(KERN_ERR "[slr] use msg2xxx_yyyy_update_bin\n");        
